...
function Login() {
	...
	const login = event => {
		event.preventDefault(); // if you have a form, it's gonna cause the page to refresh. This will stop the refresh
		// do the login logic...
	...
	const register = event => {
		event.preventDefault(); // This will stop the refresh. Do the register logic...
